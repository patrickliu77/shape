// The original built-in Calculus textbook. Theorems live in theorems-data.ts
// (kept as the legacy export so the prewarm script and tests still find
// them); chapter structure is defined here.
...
export const calculusBook: BuiltinBook = {
  id: "calculus",
