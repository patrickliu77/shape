...
export const theorems: Theorem[] = [
...

  {
    ...
    transcript: {
      en: "Random events on one timeline, all at rate lambda. From that single picture, three distributions. Count the events in a window: Poisson. Measure the gap between two events: Exponential. Wait for the k-th event: Gamma. One process, three views, one lambda.",
      ar: "أحداث عشوائية على خط زمني واحد، كلها بمعدّل لامدا. من نفس الصورة، تلات توزيعات. عدّ الأحداث في نافذة: بواسون. قيس الفرق بين حدثين: أسّي. انتظر لحد الحدث رقم k: جاما. عملية واحدة، تلات وجهات نظر، لامدا واحدة.",
    },
  },
];
