...
export function FormalDefinition({ kind, name, body }: Props) {
  ...
  return (
    <div className="my-5 border border-stone-300 dark:border-stone-700 bg-stone-50 dark:bg-[#1f1b2c] px-5 py-4 text-stone-900 dark:text-stone-100 leading-relaxed max-w-full overflow-hidden">
